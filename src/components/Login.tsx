...
function Login({ isOpen, onClose }: ILogin) {
    const icons = [
        { icon: <FaGuitar className="text-9xl text-blue-500" />, label: "Guitar", text: "Help us become one of the safest places to buy and sell" },
        { icon: <FaBuilding className="text-9xl text-red-500" />, label: "Home", text: "Express yourself with confidence and security" },
        { icon: <FaCar className="text-9xl text-green-500" />, label: "Car", text: "Let the beats of trust and safety lead the way" }
    ];
            ...
            <div className="relative w-full max-w-md bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="flex items-center justify-between px-6 py-6">
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <h3 className="mt-3 text-lg font-semibold text-gray-800">{icons[currentIndex].label}</h3>
                        <p className="mt-2 text-sm text-gray-500 max-w-xs">{icons[currentIndex].text}</p>
                    </div>
                ...
                <div className="pt-4 text-center">
                    <p className="text-sm text-gray-600">All your personal details are safe with us.</p>
